...
module ProductVariantFields
  ...
  included do
    ...
    field :is_variant_parent, Boolean, null: false, description: 'Je produkt rodičovský pro varianty?'
    field :is_variant_child, Boolean, null: false, description: 'Je produkt variantou jiného produktu?'
    field :is_standalone_product, Boolean, null: false, description: 'Je produkt samostatný (není parent ani child)?'
